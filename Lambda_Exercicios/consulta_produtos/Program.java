...
public class Program {
    public static void main(String[] args) {
        ...
        Produto produtoOld1 = new Produto_old("Cafe Chocolate Trufado Baggio",
                21.99, 250, 120, TiposProduto_.COZINHA);

        Produto produtoOld2 = new Produto_old("Leite Condensado Moca",
                6.29, 395, 200, TiposProduto_.COZINHA);

        Produto produtoOld3 = new Produto_old("Carro Vortex",
                799.90, 1560, 5, TiposProduto_.BRINQUEDO);

        Produto produtoOld4 = new Produto_old("Smart TV LED 32 HD LG",
                1452.55, 6300, 7, TiposProduto_.ELETRONICO);

        Produto produtoOld5 = new Produto_old("Nintendo Switch",
