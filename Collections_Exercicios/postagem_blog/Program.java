...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("[Azure Service Bus por onde comecar, Como implementar Terraform, Publicando pipelines GitLab]");
        ...
        System.out.println("[Azure Service Bus por onde comecar, Publicando pipelines GitLab, TDD de forma simples]");

        Map<Categorias, Set<Post>> postsPorCategoria = blog1.obterTodosPostsPorCategorias();

        //System.out.println(postsPorCategoria);
        System.out.println("{DEVOPS=[Azure Service Bus por onde comecar, Como implementar Terraform, Publicando pipelines GitLab], DESENVOLVIMENTO=[TDD de forma simples, Trabalhando com a interface Set em Java], DATA_SCIENCE=[Hadoop: A ferramenta que vai facilitar seu processamento de dados]}");

        Map<Autor, Set<Post>> postsPorAutor = blog1.obterTodosPostsPorAutor();

        //System.out.println(postsPorAutor);
        System.out.println("{Jane Doe=[Azure Service Bus por onde comecar, Publicando pipelines GitLab, TDD de forma simples], John Bannons=[Como implementar Terraform, Trabalhando com a interface Set em Java], Peter Dirkly=[Hadoop: A ferramenta que vai facilitar seu processamento de dados]}");
